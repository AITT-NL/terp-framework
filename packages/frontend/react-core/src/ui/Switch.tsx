 ...
 * go inside one: the switch renders its own `<label>` around the input, and a `<label>`
...
export function Switch({
  ...
  return (
    ...
    // so React would unmount the label and mount a fresh input — an uncontrolled switch would
    // silently lose its state exactly when the form told the user something was wrong.
