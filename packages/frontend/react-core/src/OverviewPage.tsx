 ...
 * whose crumb is the trail's root — detail pages under it link back here — so every module's
 * overview is constructed the same. Compose the body from `ResourceList` (or any listing UI).
