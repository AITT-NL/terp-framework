...
- **Every component's base styles have moved out of inline `style={}` and into the
  ...
  `!important` on every state rule it had: **35 declarations at 0.7.0, now 8**, and
  each of the eight survivors is a rule whose selector still matches at least one
