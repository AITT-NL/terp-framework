...
renderTerpApp({
  title: { id: "app.title", message: "Terp example" },
  ...
  ssoProviders: [{ name: "dex", label: { id: "auth.dex.label", message: "Dex" } }],
