...
76 specimens in 8 groups. The accessibility lane runs them in **every** shipped theme (380
axe runs across five palettes); the screenshots cover the **two default** themes (152
...
three-test keyboard lane for the one thing neither of the others can see. **537 checks.**

One of those 76 earns a note, because it is the only specimen whose subject is a token
